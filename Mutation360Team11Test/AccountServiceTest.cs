...
public class AccountServiceTest
{
    ...
    public void Constructor_ShouldAssignExternalService()
    {
        ...
        // If _externalService wasn't assigned, this would throw a NullReferenceException
        accountService.GetApplicationName(0);
    }
    ...
    public void GetAllAccount_ShouldReturnNewList_WhenAccountsIsNull()
    {
        ...
        Assert.NotNull(result);
        Assert.Empty(result);
        Assert.NotSame(accounts, result); // Ensure a new list is created
    }
