...
public class AccountServiceTest
{
    ...
    [Fact]
    public void Constructor_InitializesExternalService()
    {
        // Arrange
        var mockExternalService = new Mock<IExternalService>();
        ...
        // This will throw a NullReferenceException if _externalService is not initialized.
    ...
    public void GetAllAccount_ShouldReturnNewEmptyList_WhenAccountsIsNull()
    {
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Same(result, new List<Account>()); // Check if a new list is returned
    }
