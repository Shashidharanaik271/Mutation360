...
public class AccountServiceTest
{
    ...
    public void Constructor_ShouldAssignExternalService()
    {
        ...
        // Assert - Indirectly assert by calling a method that uses the dependency
        // This will throw a NullReferenceException if _externalService is not assigned.
    ...
    [Fact]
    public void GetAllAccountTypeAndDescription_ShouldMapPropertiesToDto()
    {
        // Arrange
        var accounts = new List<Account>
        {
    ...
    [Fact]
    public void GetAccountKeySecondElement_NullAccountKey_ThrowsNullReferenceException()
    {
        // Arrange
        string accountKey = null;

        // Act & Assert
        Assert.Throws<NullReferenceException>(() => _accountService.GetAccountKeySecondElement(accountKey));
    }
    ...
    [InlineData("TestName", "TestDescription", "")]
    [InlineData("TestName", "TestDescription", "  ")]
    public void GetAccountIdByOtherInformationAsString_NameAndDescriptionValidKeyInvalid_ThrowsException(string name, string description, string key)
    {
        // Act & Assert
        Assert.Throws<Exception>(() => _accountService.GetAccountIdByOtherInformationAsString(name, description, key));
    }
    ...
    [Fact]
    public void GetAllAccount_ShouldReturnEmptyList_WhenAccountsIsNull_MutationTest()
    {
        // Arrange
        List<Account> accounts = null;
        ...
        Assert.NotNull(result);
        Assert.Empty(result);
        Assert.NotSame(accounts, result); // Ensure a new list is returned
    }
